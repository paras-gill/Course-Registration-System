...
excel_file_path = os.path.join(current_directory, 'fake_data', 'fake50students.xlsx')

# Load the Excel file
workbook = load_workbook('fake50students.xlsx')  # Provide the path to your Excel file
